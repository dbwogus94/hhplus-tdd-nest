...
describe('PointService - integration TEST', () => {
  ...
  /**
   * 포인트 충전 동시성 테스트
   * - 포인트 충전이 동시에 요청 되었을때 정상적으로 동작하는지 확인하기 위한 테스트 입니다.
   * ### TC
   * 1. 성공
  ...
  /**
   * 포인트 사용 동시성 테스트
   * - 포인트 사용이 동시에 요청 되었을때 정상적으로 동작하는지 확인하기 위한 테스트 입니다.
   *
   * ### TC
   * 1. 성공
  ...
  /**
   * 포인트 충전과 사용 동시성 테스트
   * - 포인트 충전과 사용이 동시에 요청 되었을때 정상적으로 동작하는지 확인하기 위한 테스트 입니다.
   *
   * ### TC
   * 성공
   ...
   * - 다양한 유저가 동시에 포인트 충전시 에러가 발생해도 다른 요청은 성공해야 한다.
   */
